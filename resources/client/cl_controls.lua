...
CreateThread(function()
    while true do
        ...
        if isPauseOpen then if exports.npwd:isPhoneVisible() then exports.npwd:setPhoneVisible(false) end end
    end
end)

AddEventHandler("npwd:disableControlActions", function(bool) disableKeys = bool end)
